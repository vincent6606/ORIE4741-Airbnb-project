...
<p align="center">
<img src="Pictures/14.png" width="500">
</p>
<p>
...
We compare the mean and variance of the error under different filtering rules. When we take G=10,5,2, the median of absolute error between predicted price and real value are 19.15,22.02,25.01. We plot the histogram of G=all samples(left figure), G=10 (right figure).
